...
public class Utils {
	...
	public static String getLocalIPAddress() {
		...
		/*try {
			...
			Log.e("AndroidNetworkAddrFact", "getLocalIPAddress()", ex);
        ...
        /*
         * This link was a good solution. It was the third most popular answer.
         * However, it used a depricated method formatIpAddress.
         *
